...
for c in spike_times_clusters.keys():
    ...
    if evoked_rate_mean >=  baseline_rate_mean + 10:
        ...
        axs[2].plot(time_vector, mean_psth_low_normalized, color='black', linestyle='--', label='Low Pupil Diameter')
        axs[2].plot(time_vector, mean_psth_high_normalized, color='red', label='High Pupil Diameter')
